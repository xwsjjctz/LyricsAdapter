...
export const predefinedThemes: ThemeConfig[] = [
  {
    id: THEME_IDS.DEFAULT_DARK,
    name: '默认深色',
    description: '取色自 App Icon 的粉蓝渐变深色主题',
    icon: 'dark_mode',
    isDark: true,
    tags: ['默认', '深色', '粉蓝'],
    colors: {
      primary: '#f19bd1',
      primaryHover: '#f6b4dc',
      primaryLight: 'rgba(238, 166, 217, 0.18)',
      backgroundDark: '#15121d',
      backgroundGradientStart: '#17131f',
      backgroundGradientEnd: '#111b2a',
      backgroundSidebar: '#1d1927',
      backgroundCard: 'rgba(255, 247, 252, 0.055)',
      backgroundCardHover: 'rgba(255, 247, 252, 0.09)',
      textPrimary: '#fff7fc',
      textSecondary: 'rgba(247, 237, 248, 0.74)',
      textMuted: 'rgba(234, 220, 238, 0.48)',
      borderLight: 'rgba(238, 226, 249, 0.11)',
      borderHover: 'rgba(238, 226, 249, 0.22)',
      accent: '#8fb8ff',
      accentHover: '#a9c8ff',
      success: '#67c99a',
      warning: '#efb968',
      error: '#f1849c',
      info: '#8fb8ff',
      shadowColor: 'rgba(6, 3, 12, 0.42)',
      glowColor: 'rgba(241, 155, 209, 0.24)',
    },
    fonts: {
  ...
  {
    id: THEME_IDS.DEFAULT_LIGHT,
    name: '默认浅色',
    description: '取色自 App Icon 的粉蓝渐变浅色主题',
    icon: 'light_mode',
    isDark: false,
    tags: ['默认', '浅色', '粉蓝'],
    colors: {
      ...
      backgroundDark: '#fff8fc',
      backgroundGradientStart: '#fff7fb',
...
export function getDefaultTheme(): ThemeConfig {
  return predefinedThemes.find(theme => theme.id === THEME_IDS.DEFAULT_DARK)!;
}
